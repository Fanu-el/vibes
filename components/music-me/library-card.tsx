...
import type { Library } from "@/features/music-me/music-me-types";
...
export function LibraryCard({ item, onPress, onDelete }: LibraryCardProps) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.cardInfo}>
        ...
        >
          {item.itemCount} {item.itemCount === 1 ? "item" : "items"} • {item.isPublic ? "Public" : "Private"}
        </Text>
      </View>
